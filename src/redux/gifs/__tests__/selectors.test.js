...
describe('gif selectors', () => {
  ...
  it('.getTrendingGifObjList', () => {
    expect(selectors.getTrendingGifObjList(state)).toMatchSnapshot();
  });

  it('.getGifFromId', () => {
    expect(selectors.getGifFromId(id)(state)).toMatchSnapshot();
  });

  it('.getPreviewStillFromId', () => {
    expect(selectors.getPreviewStillFromId(id)(state)).toMatchSnapshot();
  });

  it('.getPreviewGifFromId', () => {
    expect(selectors.getPreviewGifFromId(id)(state)).toMatchSnapshot();
  });

  it('.getOriginalGifFromId', () => {
    expect(selectors.getOriginalGifFromId(id)(state)).toMatchSnapshot();
  });
});
